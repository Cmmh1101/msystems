...
Full plan in [`docs/phase-d-client-portal-spec.md`](docs/phase-d-client-portal-spec.md). Built so far (spec's steps 1–4 of 6):
...
Not yet built: the Stripe billing gate (step 5) and public case studies (step 6) — see the spec's suggested build order for what's next.
